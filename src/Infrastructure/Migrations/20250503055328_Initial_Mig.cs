        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsedRecoveryCount = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Chains_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Chains_Challenges_ChallengeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChainEntries", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ChainEntries_Chains_ChainId",
                        column: x => x.ChainId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChainEntries_ChainId",
                table: "ChainEntries",
                column: "ChainId");

            migrationBuilder.CreateIndex(
                name: "IX_Chains_CategoryId",
                table: "Chains",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Chains_ChallengeId",
                table: "Chains",
                column: "ChallengeId");
